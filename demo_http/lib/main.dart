...
class _MyHomePageState extends State<MyHomePage> {
  ...
  _getIPAddress() async { 
    ...
    var url = 'http://v.juhe.cn/weather/index?cityname=上海&dtype=&format=&key=fbb65bf5ce3bf72f3efaf4b4d994fbef';  
    ...
    try {
      ...
      if (response.statusCode == HttpStatus.OK) {
        ...
        result = data['result']['sk']['temp'].toString();    //多维数组，请根据自己请求接口的结果对json数据结构进行拆解
      } else {
        result =
