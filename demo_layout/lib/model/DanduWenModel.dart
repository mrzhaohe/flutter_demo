...
part 'DanduWenModel.g.dart';


@JsonSerializable()
  class DanduWendModel extends Object {
  ...
  DanduWendModel(this.status,this.datas,this.msg,this.code,);

  factory DanduWendModel.fromJson(Map<String, dynamic> srcJson) => _$DanduWendModelFromJson(srcJson);

  Map<String, dynamic> toJson() => _$DanduWendModelToJson(this);
